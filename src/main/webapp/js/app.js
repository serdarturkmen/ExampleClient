...
app.controller('NavCtrl', function($scope, $window, $location, $http){
    $scope.authUrl = 'http://localhost:10000/oauth/authorize?client_id=6mxWfr2IuJ6NVIBDKCh4cIhSjZj6npkiKnhZgjSD&response_type=token&scope=write&redirect_uri=http://localhost:20000/implicit-client/';
